	...
	<form name="Calc" method="post" action="calc">
		<table>
			...
			<tbody align= "center">
				...
				<tr>
					<td>
						<input type="button" name="sqrt" value="√" OnClick="Calc.LCD.value += ' √ '">
						<input type="button" name="pow" value="^" OnClick="Calc.LCD.value += ' ^ '">
				...
				<tr>
					<td>
						...
						<input type="button" name="mult" value="x" OnClick="Calc.LCD.value += ' x '">
					</td>
				</tr>
				<tr>
					<td>
